...
class KYCTabStripViewController: BaseButtonBarPagerTabStripViewController<KYCTabCollectionViewCell>, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        buttonBarItemSpec = ButtonBarItemSpec.nibFile(nibName: "KYCTabCollectionViewCell", bundle: Bundle(for: KYCTabCollectionViewCell.self), width: { (_: IndicatorInfo) -> CGFloat in
            return 55.0
        })
    }
