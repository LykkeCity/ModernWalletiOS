...
//        MenuItem(title: Localize("menu.newDesign.marketCap"), image: #imageLiteral(resourceName: "CHECK PRICES"), storyboardName: "MarketCap"), Uncomment once there is an API Endpoint for getting crypto capitalization. https://api.coinmarketcap.com is not a free service
