    ...
    override func viewDidLoad() {
        ...
        totalBalanceViewModel.isEmpty
            .drive(onNext: { [weak self] isEmpty in
                ...
                guard let emptyWalletVC = storyboard.instantiateViewController(withIdentifier: "EmptyWallet") as? EmptyWalletViewController else { return }
        ...
        assets.asObservable()
            .bind(to: collectionView.rx.items(cellIdentifier: "AssetCell", cellType: AssetCollectionViewCell.self)) { (_, element, cell) in
